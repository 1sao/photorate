...
data class LandmarkedImage(val hands: List<Hand>, val detectedInMs: Long) {
  data class Hand(
     ...
     */
    @Deprecated(
      "Should be removed. Current LiteRT models handle recognition fine without the extra complexity rotation was introducing."
    )
     ...
     */
    @Deprecated(
      "Should be removed. Current LiteRT models handle recognition fine without the extra complexity edge scans were introducing."
    )
