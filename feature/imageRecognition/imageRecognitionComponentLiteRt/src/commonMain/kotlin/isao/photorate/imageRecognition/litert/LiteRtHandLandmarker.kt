 ...
 * (`imageRecognitionComponentOnnx.AndroidOnnxHandLandmarker`) that swaps ONNX Runtime sessions for
 * the LiteRT conversions of the same two models (ml/litert/ recipe; assets shipped from
 * ml/litert/converted):
 *
