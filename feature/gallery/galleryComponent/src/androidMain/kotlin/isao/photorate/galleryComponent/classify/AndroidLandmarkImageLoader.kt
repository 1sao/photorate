...
/**
 * Android [LandmarkImageLoader]: decodes a gallery URI to a [Bitmap] whose shortest edge is around
 * [maxDimension]. The old MediaPipe and ONNX loaders differed only in that constant (224 vs 640),
 * so they were merged here.
 */
@Factory
