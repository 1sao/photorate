 ...
 * PHImageManager into a [UIImage] (the common candidate on iOS). Mirrors the galleryOld data
 * source's loader; the iOS scan pipeline is still dormant, so this stays placeholder-quality.
 */
