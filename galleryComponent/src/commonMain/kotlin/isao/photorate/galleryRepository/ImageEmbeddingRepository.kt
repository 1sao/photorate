...
interface ImageEmbeddingRepository {
    /**
     * All stored embeddings. Rows exist only for hand images (population
     * filters to images with real detections), so search ranking over these IS
     * a search over images with detected hands.
     */
