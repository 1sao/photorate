...
kotlin {
    ...
    sourceSets {
        ...
        androidMain.dependencies {
            ...
            // run on-device via ONNX Runtime (same artifact MobileCLIP search uses).
            implementation(libs.onnxruntime.android)
            // `javax.inject.Inject` on the factory mirrors photosMediaPipe's
            // factory pattern; the factories are constructed by the platform's
            // LandmarkerFactoryProvider, so this is only for test construction.
