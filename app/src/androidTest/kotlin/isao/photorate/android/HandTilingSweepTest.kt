...
/**
 * Validates the tiling hypothesis for the 3 samples the palm detector misses on the full image
 * (4/4.jpg, 4/4_also.jpg, 5/5_horizontal.jpg): the palm detector inside HandLandmarker internally
 * resizes the whole input to ~192x192, so a small hand gets compressed away. Running detection on
 * overlapping crops of the image makes the hand a large fraction of each tile's detector input.
 */
