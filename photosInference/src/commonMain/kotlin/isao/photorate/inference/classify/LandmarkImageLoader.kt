 ...
 * [maxDimension] target (shortest edge) comes from the active model's options —
 * the MediaPipe pipeline historically decoded at 224px and the ONNX one at
 * 640px (larger crops keep more detail for the landmark models).
 */
