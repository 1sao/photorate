...
/**
 * Calculates thumb rating (1-5) from hand landmarks. 1 = thumb fully down, 5 = thumb fully up.
 *
 * MediaPipe hand landmarks for thumb: 0: WRIST, 1: THUMB_CMC, 2: THUMB_MCP, 3: THUMB_IP, 4:
 * THUMB_TIP
 */
