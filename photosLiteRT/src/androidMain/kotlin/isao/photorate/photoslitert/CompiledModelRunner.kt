...
class CompiledModelRunner private constructor(private val model: CompiledModel) : AutoCloseable {
    ...
    companion object {
        ...
        /**
         * Compiles a bundled asset with caller-provided options (e.g. GpuOptions
         * backend selection for on-device verification).
         */
        fun fromAssets(context: Context, fileName: String, options: CompiledModel.Options): CompiledModelRunner =
