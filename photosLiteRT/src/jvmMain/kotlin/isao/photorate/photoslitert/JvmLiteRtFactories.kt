...
/**
 * JVM [HandLandmarkerFactory] backed by the shared LiteRT pipeline and
 * kmplitert engines (the JVM jar bundles the native dylib). Models are loaded
 * from [modelsDir] on disk.
 */
...
class JvmLiteRtAppClipSearchFactory(private val modelsDir: String, private val tokenizerJson: String) : AppClipSearchFactory {
