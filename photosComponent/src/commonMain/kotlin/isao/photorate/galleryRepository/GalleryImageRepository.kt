...
interface GalleryImageRepository {
    ...
    /**
     * Atomically rejects an image's detections: removes its real hands and CLIP
     * embedding and marks it DONE, so it behaves like a scanned image with no
     * hand (and drops out of search). Used by the uncertain review's delete.
     */
