...
/**
 * Unit tests for [cosineSimilarity] — the metric used to rank photos by how
 * well their embeddings match a text query.
 */
class CosineSimilarityTest {
    ...
    fun `identical vectors have similarity 1`() {
        ...
        assertEquals(1.0, cosineSimilarity(v, v), absoluteTolerance = 1e-9)
    }
    ...
    fun `proportional vectors have similarity 1`() {
        ...
        assertEquals(1.0, cosineSimilarity(a, b), absoluteTolerance = 1e-9)
    }
    ...
    fun `orthogonal vectors have similarity 0`() {
        ...
        assertEquals(0.0, cosineSimilarity(a, b), absoluteTolerance = 1e-9)
    }
    ...
    fun `zero vector yields similarity 0 instead of NaN`() {
        ...
        assertTrue(result.isFinite(), "zero vector must not produce NaN/Infinity")
